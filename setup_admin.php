 ...
 * URL: http://localhost/workwave/setup_admin.php
...
echo '<p style="font-family:sans-serif;color:red;"><strong>⚠️ Delete this file now: setup_admin.php</strong></p>';
echo '<p style="font-family:sans-serif;"><a href="/workwave/index.php?action=login">Go to Login →</a></p>';
?>
