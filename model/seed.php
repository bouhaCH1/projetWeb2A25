...
for ($i = 1; $i <= 32; $i++) {
    ...
    $email = 'company' . $i . '@workwave.local';
...
for ($i = 1; $i <= 64; $i++) {
    ...
    $email = 'freelancer' . $i . '@workwave.local';
...
$db->exec("INSERT INTO activity_logs(user_id,action,details,ip_address,created_at) VALUES(NULL,'seed.complete','Generated 32 companies, 64 freelancers, jobs, portfolios and applications','cli',NOW())");
