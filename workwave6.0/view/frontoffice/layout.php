<?php $userRole = $_SESSION['role'] ?? null; ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="<?= assetUrl('view/frontoffice/template_generale/templatemo-graph-page.css') ?>">
    <link rel="stylesheet" href="<?= assetUrl('view/frontoffice/assets/workwave.css') ?>">
...
<script src="<?= assetUrl('view/frontoffice/template_generale/templatemo-graph-script.js') ?>"></script>
<script src="<?= assetUrl('view/frontoffice/assets/workwave.js') ?>"></script>
