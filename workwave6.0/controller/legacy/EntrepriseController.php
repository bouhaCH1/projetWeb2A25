...
class EntrepriseController {
    ...
    public function dashboard() {
        ...
        require_once dirname(__DIR__, 2) . '/view/legacy/entreprise/dashboard.php';
    }
    ...
    public function viewPortfolio($id) {
        ...
        require_once dirname(__DIR__, 2) . '/view/legacy/entreprise/portfolio_detail.php';
    }
    ...
    public function submitJob() {
        ...
        require_once dirname(__DIR__, 2) . '/view/legacy/entreprise/job_form.php';
    }
    ...
    public function viewApplications($job_id) {
        ...
        require_once dirname(__DIR__, 2) . '/view/legacy/entreprise/applications.php';
    }
