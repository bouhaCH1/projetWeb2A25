...
class AdminController {
    ...
    public function dashboard() {
        ...
        require_once dirname(__DIR__, 2) . '/view/legacy/admin/dashboard.php';
    }
    ...
    public function pendingPortfolios() {
        ...
        require_once dirname(__DIR__, 2) . '/view/legacy/admin/pending_portfolios.php';
    }
    
    public function approvedPortfolios() {
        $this->checkAdmin();
        $portfolios = $this->model->getApprovedPortfolios();
        require_once dirname(__DIR__, 2) . '/view/legacy/admin/approved_portfolios.php';
    }
    ...
    public function viewPendingPortfolio($id) {
        ...
        require_once dirname(__DIR__, 2) . '/view/legacy/admin/view_pending.php';
    }
    ...
    public function pendingJobs() {
        ...
        require_once dirname(__DIR__, 2) . '/view/legacy/admin/pending_jobs.php';
    }
    ...
    public function candidats() {
        ...
        require_once dirname(__DIR__, 2) . '/view/legacy/admin/candidats.php';
    }
    ...
    public function entreprises() {
        ...
        require_once dirname(__DIR__, 2) . '/view/legacy/admin/entreprises.php';
    }
