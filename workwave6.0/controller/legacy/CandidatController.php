...
class CandidatController {
    ...
    public function dashboard() {
        ...
        require_once dirname(__DIR__, 2) . '/view/legacy/candidat/dashboard.php';
    }
    ...
    public function submitPortfolio() {
        ...
        require_once dirname(__DIR__, 2) . '/view/legacy/candidat/portfolio_form.php';
    }
    ...
    public function jobDetail($id) {
        ...
        require_once dirname(__DIR__, 2) . '/view/legacy/candidat/job_detail.php';
    }
