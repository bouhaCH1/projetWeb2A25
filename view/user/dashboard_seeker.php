...
<div class="action-grid" style="margin-bottom:24px;">
    ...
    <a href="#" class="action-card" style="border-style: dashed; cursor: default;">
        ...
        <div class="action-card-title">Mes candidatures</div>
        <div class="action-card-desc">Suivez vos candidatures (Bientôt disponible)</div>
    </a>
    ...
    <a href="#" class="action-card" style="border-style: dashed; cursor: default;">
        ...
        <div class="action-card-title">Emplois sauvegardés</div>
        <div class="action-card-desc">Voir vos offres favorites (Bientôt disponible)</div>
    </a>
...
<div class="dsh-card" style="margin-bottom: 24px;">
    <div class="dsh-card-head" style="display:flex; justify-content:space-between; align-items:center; border-bottom: 1px solid var(--border-color); padding-bottom: 15px; margin-bottom: 15px;">
        <div class="dsh-card-title">Emplois recommandés</div>
        <a href="#" class="btn btn-outline" style="padding: 6px 12px; font-size: 0.85rem;" onclick="event.preventDefault();">Tout parcourir</a>
    </div>
    <div class="job-list" style="display: flex; flex-direction: column; gap: 12px;">
        ...
        <div style="border: 1px solid var(--border-color); padding: 16px; border-radius: 8px; display: flex; justify-content: space-between; align-items: center; background-color: var(--card-bg);">
            <div>
                <h4 style="margin: 0 0 6px 0; color: var(--gold-light); font-size: 1.1rem;">Développeur Frontend</h4>
                <div style="color: #888; font-size: 0.9rem; display: flex; flex-wrap: wrap; gap: 15px;">
                    ...
                    <span style="display:flex; align-items:center; gap:4px;"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg> Distanciel</span>
            ...
            <a href="#" class="btn btn-outline" style="padding: 6px 16px; font-size: 0.85rem;" onclick="event.preventDefault();">Voir les détails</a>
        </div>
        
        <!-- Static Job Item 2 -->
        <div style="border: 1px solid var(--border-color); padding: 16px; border-radius: 8px; display: flex; justify-content: space-between; align-items: center; background-color: var(--card-bg);">
            <div>
                <h4 style="margin: 0 0 6px 0; color: var(--gold-light); font-size: 1.1rem;">Designer UX/UI</h4>
                <div style="color: #888; font-size: 0.9rem; display: flex; flex-wrap: wrap; gap: 15px;">
                    ...
                    <span style="display:flex; align-items:center; gap:4px;"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg> Paris, FR</span>
        ...
        <div style="border: 1px solid var(--border-color); padding: 16px; border-radius: 8px; display: flex; justify-content: space-between; align-items: center; background-color: var(--card-bg);">
            <div>
                <h4 style="margin: 0 0 6px 0; color: var(--gold-light); font-size: 1.1rem;">Analyste de données</h4>
                <div style="color: #888; font-size: 0.9rem; display: flex; flex-wrap: wrap; gap: 15px;">
                    ...
                    <span style="display:flex; align-items:center; gap:4px;"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg> Lyon, FR</span>
