...
<div class="content_box">
    ...
    <form id="registerForm" action="/job_platform/index.php?action=register_submit" method="POST" novalidate>
        ...
        <a href="/job_platform/index.php?action=login" class="btn btn-secondary">Already have an account?</a>
