            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <?php if ($role === 'admin'): ?>
                        ...
                        <a href="/workwave/Controller/index.php?action=admin_missions" class="nav-item nav-link <?= in_array($action, ['admin_missions', 'admin_mission_create', 'admin_mission_edit', 'admin_mission_candidatures']) ? 'active' : '' ?>"><i class="fa fa-briefcase me-2"></i>Missions</a>
