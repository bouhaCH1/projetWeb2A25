...
<div class="candidatures-container fade-in">
    ...
    <header class="d-flex align-items-center justify-content-between mb-4">
        ...
        <a href="index.php?action=admin_missions" class="btn btn-outline-light px-4 py-2 fw-bold">
    ...
    <div style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); border-radius: 20px; padding: 25px; margin-bottom: 40px; box-shadow: 0 10px 30px rgba(0,0,0,0.2);">
        <form method="GET" action="index.php" class="row g-4 align-items-center">
            <input type="hidden" name="action" value="admin_mission_candidatures">
            ...
            <div class="col-lg-3">
                <div class="d-flex gap-2">
                    ...
                    <?php if(!empty($_GET['mission_id']) || !empty($_GET['sort'])): ?>
                        <a href="index.php?action=admin_mission_candidatures" class="btn btn-dark px-3 rounded-3 d-flex align-items-center justify-content-center" title="Reset">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2 justify-content-center flex-wrap">
                                    ...
                                    <a href="index.php?action=admin_mission_delete_candidature&id=<?= $c['id'] ?>" 
