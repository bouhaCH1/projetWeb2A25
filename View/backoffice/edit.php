...
<div class="creation-container">
    ...
    <header class="d-flex align-items-center justify-content-between mb-5 animate-up">
        ...
        <div class="d-flex gap-3">
            <a href="index.php?action=index" class="btn-forge-outline btn-sm text-decoration-none">
                <i class="fas fa-chevron-left me-2"></i> Annuler
            </a>
        </div>
    </header>

    <form id="missionForm" method="POST" action="index.php?action=edit&id=<?= $missionData['id'] ?>" novalidate class="needs-validation">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <div class="d-grid gap-3 animate-up stagger-3">
                    ...
                    <a href="index.php?action=index" class="btn-forge-outline w-100 py-3 text-center text-decoration-none border-danger-subtle text-danger">
