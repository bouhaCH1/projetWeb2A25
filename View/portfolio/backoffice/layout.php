...
<head>
    ...
    <link href="<?= assetUrl('view/portfolio/backoffice/template_admin/darkpan-1.0.0/css/bootstrap.min.css') ?>" rel="stylesheet">
    <link href="<?= assetUrl('view/portfolio/backoffice/template_admin/darkpan-1.0.0/css/style.css') ?>" rel="stylesheet">
    <link href="<?= assetUrl('view/portfolio/backoffice/assets/admin.css') ?>" rel="stylesheet">
</head>
<body>
...
<script src="<?= assetUrl('view/portfolio/backoffice/template_admin/darkpan-1.0.0/lib/chart/chart.min.js') ?>"></script>
<script src="<?= assetUrl('view/portfolio/backoffice/template_admin/darkpan-1.0.0/js/main.js') ?>"></script>
<script src="<?= assetUrl('view/portfolio/backoffice/assets/admin.js') ?>"></script>
</body>
</html>
