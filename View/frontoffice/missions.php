...
<section class="hero" style="min-height: 60vh; padding: 100px 0 60px;">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <form method="get" action="/workwave/Controller/index.php">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="row g-4">
                    <div class="col-md-4">
                        <a href="/workwave/Controller/index.php?action=front_create" style="text-decoration: none;">
                    ...
                    <div class="col-md-4">
                        <a href="/workwave/Controller/index.php?action=front_missions" style="text-decoration: none;">
                            <div class="cyber-card" style="text-align: center; padding: 30px;">
                                <div style="width: 60px; height: 60px; background: linear-gradient(135deg, #00ffcc, #00ccff); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 15px;">
                    ...
                    <div class="col-md-4">
                        <a href="/workwave/Controller/index.php?action=front_candidatures" style="text-decoration: none;">
                            <div class="cyber-card" style="text-align: center; padding: 30px;">
                                <div style="width: 60px; height: 60px; background: linear-gradient(135deg, #00ffcc, #00ccff); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 15px;">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div style="background: rgba(10, 14, 39, 0.6); backdrop-filter: blur(20px); border: 1px solid rgba(0, 255, 204, 0.2); border-radius: 20px; padding: 25px; margin-bottom: 50px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
                    <form method="GET" action="/workwave/Controller/index.php" class="row g-4 align-items-center">
                        <input type="hidden" name="action" value="missions">
                        ...
                        <div class="col-lg-3">
                            <div class="d-flex gap-2">
                                ...
                                <?php if(!empty($_GET['search']) || !empty($_GET['sort'])): ?>
                                    <a href="/workwave/Controller/index.php?action=missions" class="btn" 
                        ...
                        <div class="cyber-card">
                            ...
                            <div style="padding: 25px;">
                                <h4 style="color: #ffffff; font-size: 18px; font-weight: 600; margin-bottom: 15px;">
                                    <a href="/workwave/Controller/index.php?action=front_apply&id=<?php echo (int)$mission['id']; ?>" style="color: #ffffff; text-decoration: none; transition: color 0.3s;">
                                ...
                                <?php endif; ?>
                                <a href="/workwave/Controller/index.php?action=front_apply&id=<?php echo (int)$mission['id']; ?>" class="cyber-btn" style="width: 100%; justify-content: center;">
...
async function sendChatMessage() {
    ...
    try {
        ...
        const response = await fetch('/workwave/Controller/index.php?action=ai_chat', {
            method: 'POST',
            body: formData
        });
