        ...
        <div class="row justify-content-center">
            <div class="col-lg-5">
                <div class="cyber-card" style="padding: 20px;">
                    <form method="GET" action="/workwave/Controller/index.php" style="display: flex; gap: 10px; align-items: center;">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="cyber-card" style="text-align: center; padding: 60px 30px;">
                        ...
                        <a href="/workwave/Controller/index.php?action=missions" class="cyber-btn">
                            ...
                            <div style="padding: 20px;">
                                ...
                                <div style="display: flex; gap: 10px;">
                                    <?php if ($statut !== 'acceptee' && $statut !== 'refusee'): ?>
                                        <a href="/workwave/Controller/index.php?action=front_edit_candidature&id=<?php echo $candidature['id']; ?>" class="cyber-btn" style="flex: 1; justify-content: center; font-size: 12px; padding: 8px;">
