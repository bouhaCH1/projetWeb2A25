        ...
        <div class="col-lg-4 mb-4 mb-lg-0">
          <div class="about" style="padding-right: 30px;">
            ...
            <div style="display: flex; gap: 15px; margin-top: 25px;">
              <a href="https://facebook.com/workwave" target="_blank" style="width: 40px; height: 40px; background: rgba(0, 189, 254, 0.1); border: 1px solid rgba(0, 189, 254, 0.3); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: #00bdfe; transition: all 0.3s ease; text-decoration: none;"><i class="fa fa-facebook-f"></i></a>
              <a href="https://twitter.com/workwave" target="_blank" style="width: 40px; height: 40px; background: rgba(0, 189, 254, 0.1); border: 1px solid rgba(0, 189, 254, 0.3); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: #00bdfe; transition: all 0.3s ease; text-decoration: none;"><i class="fa fa-twitter"></i></a>
              <a href="https://linkedin.com/company/workwave" target="_blank" style="width: 40px; height: 40px; background: rgba(0, 189, 254, 0.1); border: 1px solid rgba(0, 189, 254, 0.3); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: #00bdfe; transition: all 0.3s ease; text-decoration: none;"><i class="fa fa-linkedin-in"></i></a>
              <a href="https://instagram.com/workwave" target="_blank" style="width: 40px; height: 40px; background: rgba(0, 189, 254, 0.1); border: 1px solid rgba(0, 189, 254, 0.3); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: #00bdfe; transition: all 0.3s ease; text-decoration: none;"><i class="fa fa-instagram"></i></a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 mb-4 mb-lg-0">
