        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="cyber-form-card">
                    ...
                    <form method="POST" action="/workwave/Controller/index.php?action=front_edit_candidature&id=<?= (int)$candidatureData['id'] ?>" novalidate enctype="multipart/form-data">
                        <div class="row mb-4">
                        ...
                        <div class="d-flex gap-3 justify-content-end">
                            <a href="/workwave/Controller/index.php?action=front_candidatures" class="cyber-btn" style="background: transparent; border: 1px solid #00ffcc; color: #00ffcc;">
