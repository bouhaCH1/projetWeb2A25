    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 text-end">
                <a href="index.php?action=front_create" class="cyber-btn">
                        ...
                        <div class="cyber-card">
                            ...
                            <div style="padding: 20px;">
                                ...
                                <div style="display: flex; gap: 10px;">
                                    <a href="index.php?action=front_edit&id=<?php echo $mission['id']; ?>" class="cyber-btn" style="flex: 1; justify-content: center; font-size: 13px; padding: 10px;">
