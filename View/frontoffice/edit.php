        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="top-text header-text text-center">
                    ...
                    <h2 style="color: white;">Modifier la mission #<?= (int)$missionData['id'] ?></h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <div style="background: white; border-radius: 15px; padding: 40px; box-shadow: 0 5px 15px rgba(0,0,0,0.1);">
                <form id="missionForm" method="POST" action="index.php?action=front_edit&id=<?= (int)$missionData['id'] ?>" novalidate>
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <a href="index.php?action=front_missions" class="main-button" style="background: #2b2b2b; text-decoration: none; color: white; display: inline-block; padding: 12px 25px; border-radius: 25px;">
